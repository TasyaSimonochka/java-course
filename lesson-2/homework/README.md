...
- переопределены методы hashCode и equals - 0,5 балла, если средствами IDEA; 1 балл, если своими силами без использования класс-обертки Double (придется познакомиться с приведением типов до 3 занятия самостоятельно)
...
- инициализация из файла (т.е. считывание из файла информации о всех компьютерах, вызов конструктора, тут вам поможет String.split()) - 1 балл
